...
#                   ("newuser", "example@gmail.com", "100", "1000"))
    #cursor.execute("INSERT INTO Users(username,email,age,balance)VALUES(?,?,?,?)",(f"User{i+1}",f"{i+1}example@gmail.com",f"age{(i+1)*10}",f"balance (1000)"))
